...
//			agents.put(ID.Customer.LocalName+"#1", new CustomerAgent());
	...
	private static void showLicenceInvalid() {
		String message = "<html>Licence expired. Please visit"
				+ " http://smartmanager.bitbucket.org</html>";
		ImageIcon img = new ImageIcon("resources/smartManager.png");
		JOptionPane.showMessageDialog(new JFrame(), message, 
				"Smart Manager :: Licence expired", JOptionPane.ERROR_MESSAGE);
	}

	private static boolean licenceValid() {
